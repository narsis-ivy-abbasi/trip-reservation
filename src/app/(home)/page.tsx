    ...
    <>
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md px-4 ">
            <div className="flex items-center bg-white rounded-lg w-full p-3">
              ...
              <input
                ...
                className="w-full py-2 px-3 border border-indigo-400 outline-none rounded-lg focus:ring-1 focus:ring-blue-400"
              />
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-between  mx-auto container">
        <div className="flex flex-col justify-between items-center mx-5 md:mx-0">
          <h2 className="text-4xl text-indigo-800 font-bold mt-10 w-full">
            Popular Locations
          </h2>
        ...
        <div className="flex flex-col items-center gap-5 lg:flex-row md:justify-center lg:justify-between w-full mt-20 mx-auto">
          <div>
            <TitleCard
        ...
        <div className="flex flex-col justify-between items-center mx-5 md:mx-0">
          <h2 className="text-4xl text-indigo-800 font-bold mt-20 text-left w-full">
            Best Hotels
          </h2>
          <h3 className="w-full text-2xl text-gray-400">
            A selection of quality accommodations with hospitable hosts
        ...
        <div className="flex flex-col justify-between items-center my-20 md:mx-0">
          <h2 className="text-4xl text-indigo-800 font-bold   text-left w-full">
            User Comments
          </h2>
          <h3 className="w-full text-2xl text-gray-400">
            A selection of user comments are gathered
          </h3>
          <CommentLayout comments={comments} />
        </div>
        <div className="flex flex-col justify-between items-center mx-5 md:mx-0">
          <h2 className="text-4xl text-indigo-800 font-bold  w-full">
      ...
      {showScroll && (
        <button
          className="fixed bottom-20 right-5 border border-indigo-400 bg-white text-indigo-400 rounded-full p-3 shadow-lg cursor-pointer hover:border-gray-100 transition"
          onClick={scrollToTop}
        >
